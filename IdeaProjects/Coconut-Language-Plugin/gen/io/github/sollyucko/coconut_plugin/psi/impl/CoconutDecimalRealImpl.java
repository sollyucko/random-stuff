...
public class CoconutDecimalRealImpl extends ASTWrapperPsiElement implements CoconutDecimalReal {

  public CoconutDecimalRealImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CoconutVisitor visitor) {
    visitor.visitDecimalReal(this);
  }
