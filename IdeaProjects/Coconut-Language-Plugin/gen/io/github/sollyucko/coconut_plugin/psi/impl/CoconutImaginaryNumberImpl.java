...
public class CoconutImaginaryNumberImpl extends ASTWrapperPsiElement implements CoconutImaginaryNumber {

  public CoconutImaginaryNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CoconutVisitor visitor) {
    visitor.visitImaginaryNumber(this);
  }
  ...
  public CoconutRealNumber getRealNumber() {
    return findNotNullChildByClass(CoconutRealNumber.class);
  }
