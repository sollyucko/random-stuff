...
public class CoconutExpressionImpl extends ASTWrapperPsiElement implements CoconutExpression {

  public CoconutExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public CoconutExpression getExpression() {
    return findChildByClass(CoconutExpression.class);
  }
